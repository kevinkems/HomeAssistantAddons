...
REPO="GoSungrow"
URL="https://api.github.com/repos/kevinkems/${REPO}/releases/latest"
...
# cd /tmp
# wget -O- https://github.com/kevinkems/GoSungrow/releases/download/v${GOSUNGROW_VERSION}/GoSungrow-linux_${ARCH}.tar.gz | tar zxvf - GoSungrow
